...
Choose where LTK Manager stores installed mods. The default location is in your app data directory. You can change this later in [Settings](Settings).
...
- [Managing Mods](Managing-Mods) — Enable, disable, reorder, and uninstall mods
- [Profiles](Profiles) — Create mod profiles to quickly switch configurations
- [Settings](Settings) — Customize LTK Manager
- [Workshop Overview](Workshop-Overview) — Start creating your own mods
