...
4. **Logs** — Relevant log file contents (see [Troubleshooting](Troubleshooting#log-files))
5. **Screenshots** — If applicable

## Development Setup

See [Building from Source](Building-from-Source) for instructions on setting up the development environment.
