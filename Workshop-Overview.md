...
Each layer has a priority that determines load order when multiple layers are active. See [Layers](Layers) for details.

## Importing Projects

You can create projects from existing sources:

- **[From .modpkg](Importing-Projects#from-modpkg)** — Extract an existing mod package into a project
- **[From .fantome](Importing-Projects#from-fantome)** — Convert a legacy fantome archive
- **[From Git](Importing-Projects#from-git)** — Clone a Git repository as a project
...
- [Layers](Layers) — Layer system details
- [Importing Projects](Importing-Projects) — Import from various sources
- [Mod Package Format](Mod-Package-Format) — Technical format specification
